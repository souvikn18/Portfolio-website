...
const About = () => {
    return (
        <div className='h-[900px] lg:h-[600px] bg-gradient-to-b from-[#121212] to-[#282828] text-white lg:py-16 pt-4' id='about'>
            <h1 className='md:text-4xl text-2xl text-center pt-16'>ABOUT ME</h1>
            <div className='lg:flex lg:flex-row lg:justify-center lg:gap-20 lg:pt-16 pt-10 flex flex-col-reverse items-center gap-10'>
                <div className='w-[300px] md:text-base text-sm px-8 py-8 md:w-[500px] lg:w-[600px] bg-[#282828] lg:px-8 lg:py-8 rounded-lg shadow-xl'>
                    <a href={resume} target='blank' className='bg-cyan-800 px-6 py-2 block mb-4 md:w-52 w-[185px] rounded-sm hover:bg-cyan-700 duration-300'>DOWNLOAD RESUME</a>
                ...
                <div >
                    <img className='md:w-64 md:h-64 lg:w-96 lg:h-96 rounded-full w-40 h-40' alt='...' src={self}/>
                </div>
            </div>
        </div>
    )
